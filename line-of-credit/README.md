...
creditLine.rb implements the following:

A line of credit product.  This is like a credit card except theres no card.
It works like this:

  - Has a built in APR and credit limit
  - Able to draw ( take out money ) and make payments.
  - Keeps track of principal balance and interest on the line of credit
  ...
  - Keeps track of transactions such as payments and draws on the line and when
    they occured.
